...
/// \date 24/01/2008
/// \version 1.1.3
/// \brief RobProb defines the pvalue, pvalues, pvalue_frame, lvalue, lvalues, lvalue_frame, plr, plr_frame, llr and llr_frame data types. These data types may be described using a number of categories. Some data types operate in the normal-domain (pvalue, pvalues, pvalue_frame, plr and plr_frame), whilst others operate in the logarithmic-domain (lvalue, lvalues, lvalue_frame, llr and llr_frame). Some data types represent only the probability of a single event outcome (pvalue, lvalue), others represent the probabilities of all outcomes of a single event (pvalues, plr, lvalues, llr) and the rest represent the probabilities of all outcomes of a set of events (pvalue_frame, plr_frame, lvalue_frame, llr_frame). Finally, some data types represent the probabilities of the arbitrary number of outcomes of generic events in an array (pvalues, pvalues_frame, lvalues, lvalues_frame), whilst others represent the probabilities of the two outcomes of binary events as a ratio (plr, plr_frame, llr, llr_frame).
